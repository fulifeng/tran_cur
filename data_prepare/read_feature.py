...
class feature_reader:
    '''
        ...
        4 for MvDA outputs
    '''
    def __init__(self, feature_fname_fname, final_list_fname, read_type=3, feature_path = './'):
        ...
        for perspective in self.feature_fnames.itervalues():
            for types in perspective.itervalues():
                for fname in types:
                    ...
                    data = np.genfromtxt(os.path.join(self.feature_path, fname), delimiter=',', dtype=float)
